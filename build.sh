...
DJANGO_TEMPLATES_DIR="$DJANGO_PROJECT_DIR/stats/templates"
DJANGO_STATIC_DIR="$DJANGO_PROJECT_DIR/static/assets"
DJANGO_REACT_HTML_FILE_NAME="react"

# Adjust paths in index.html
sed -i 's|./assets/|/static/assets/|g' "$VITE_BUILD_DIR/index.html"
...
mv "$VITE_BUILD_DIR/index.html" "$VITE_BUILD_DIR/$DJANGO_REACT_HTML_FILE_NAME.html"
rm -f "$DJANGO_TEMPLATES_DIR/$DJANGO_REACT_HTML_FILE_NAME.html"
mv "$VITE_BUILD_DIR/$DJANGO_REACT_HTML_FILE_NAME.html" "$DJANGO_TEMPLATES_DIR/$DJANGO_REACT_HTML_FILE_NAME.html"
